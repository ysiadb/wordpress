...
function traitement_formulaire_subscriber()
{
	...
	switch ($_POST) {
		...
		case isset($_POST['email']) && isset($_POST['selection']):
			...
			$userdata = array(
				'user_login' =>  $newuser,
				'user_url'   =>  'http://localhost/projets/wordpress/Daisy',
				'user_pass'  =>  NULL 
			);
			...
			if ($_POST['selection'] == 'AnswerQuestion') {
				...
				wp_redirect('/projets/wordpress/Daisy/index.php/welcome-answerer');
			}

		break;

		case $_POST['selection'] == 'AskQuestion' :
			wp_redirect('/projets/wordpress/Daisy/index.php/welcome-asker');
		break;
